          ...
          <div class="relative flex flex-1 overflow-hidden">
            <div class="flex flex-1 flex-col overflow-hidden">
              ...
              <div class="flex-1 overflow-auto">
                <div class="flex h-10 items-center rounded-md bg-muted p-1 text-muted-foreground mx-6 mt-3 justify-start shrink-0">
                  <div class="flex flex-wrap items-center gap-2">
                    <ng-container *ngFor="let section of sectionKeys">
                      <button
                        *ngIf="shouldShowSection(section)"
                        type="button"
                        class="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 relative text-destructive"
