      ...
      <div class="flex min-h-[calc(100vh-140px)] flex-col gap-0 rounded-2xl border border-border bg-card shadow-sm">
        ...
        >
          ...
          <div class="flex flex-wrap items-center gap-2">
            <button
              type="button"
              class="flex items-center gap-2 rounded-md border border-border px-3 py-1 text-xs transition hover:bg-muted"
            ...
            <button
              type="button"
              class="flex items-center gap-2 rounded-md border border-destructive px-3 py-1 text-xs text-destructive transition hover:bg-destructive/10"
              (click)="resetFilters()"
